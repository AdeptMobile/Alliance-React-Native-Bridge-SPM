...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AllianceReactNativeBridge",
            url: "https://github.com/AdeptMobile/Alliance-React-Native-Bridge-SPM/releases/download/1.2.1/AllianceReactNativeBridge.xcframework.zip",
            checksum: "c369541dfd520ad71f89a6cfcc7626b5097c3f437539dfce8705f7e0364710c4"
        ),
         .binaryTarget(
            name: "Hermes",
            url: "https://github.com/AdeptMobile/Alliance-React-Native-Bridge-SPM/releases/download/1.2.1/hermes.xcframework.zip",
            checksum: "4a3712bfe47162a0bb54895c791aa5ed28f489962d4a1df51039e1857db62bd5"
        ),
        .binaryTarget(
           name: "BlazeSDK",
           url: "https://github.com/AdeptMobile/Alliance-React-Native-Bridge-SPM/releases/download/1.2.1/BlazeSDK.xcframework.zip",
