...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AllianceReactNativeBridge",
            url: "https://github.com/AdeptMobile/Alliance-React-Native-Bridge-SPM/releases/download/1.1.5/AllianceReactNativeBridge.xcframework.zip",
            checksum: "94485ef2aed4fa0e14c12e10cc39a04ee3c362492bd1bdfea70035788ad0fbf7"
        ),
         .binaryTarget(
            name: "Hermes",
            url: "https://github.com/AdeptMobile/Alliance-React-Native-Bridge-SPM/releases/download/1.1.5/hermes.xcframework.zip",
